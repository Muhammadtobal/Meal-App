...
export class Migration1739705836014 implements MigrationInterface {
    name = 'Migration1739705836014'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`reservation\` ADD \`reservationTime\` datetime NULL`);
