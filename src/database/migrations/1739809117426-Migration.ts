...
export class Migration1739809117426 implements MigrationInterface {
    name = 'Migration1739809117426'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`DROP INDEX \`IDX_7989eba4dafdd5322761765f2b\` ON \`user\``);
        ...
        await queryRunner.query(`ALTER TABLE \`user\` ADD UNIQUE INDEX \`IDX_470355432cc67b2c470c30bef7\` (\`googleId\`)`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`user\` DROP INDEX \`IDX_470355432cc67b2c470c30bef7\``);
        await queryRunner.query(`ALTER TABLE \`user\` DROP COLUMN \`googleId\``);
        await queryRunner.query(`ALTER TABLE \`user\` ADD \`lastName\` varchar(255) NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`user\` ADD \`firstName\` varchar(255) NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`user\` ADD \`facebookId\` varchar(255) NULL DEFAULT 'NULL'`);
